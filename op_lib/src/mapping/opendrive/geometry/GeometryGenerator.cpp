...
#include "mapping/opendrive/geometry/GeometryGenerator.hpp"

#include "mapping/opendrive/geometry/CenterLine.hpp"
#include "mapping/opendrive/geometry/LaneUtils.hpp"
...
void normalizeEdge(Id const id, std::string const &what, Edge &edge)
{
  ...
  if(0)
  {
    //Remove this when start using parameters id, and what 
