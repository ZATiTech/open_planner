...
void opendrive::parser::JunctionParser::Parse(const pugi::xml_node &xmlNode,
...
void opendrive::parser::JunctionParser::ParseLaneLink(const pugi::xml_node &xmlNode,
                                                      std::vector<opendrive::JunctionLaneLink> &out_lane_link)
{
  for (pugi::xml_node junctionLaneLink = xmlNode.child("laneLink"); junctionLaneLink;
